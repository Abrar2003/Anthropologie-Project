    ...
    itemDetails.forEach(function (elem, index) {
        ...
        p5.innerText = "Fit " + elem.Fit;

        let a1 = document.createElement("a");
        a1.setAttribute("href", "#");
        a1.setAttribute("id", "edit")
        a1.innerText = "Edit";
        td2.append(p1, p2, p3, p4, p5, a1)
        ...
        remove.addEventListener("click", function () {   //T remove an item
            removeItem(index);
        });
        ...
        document.querySelector("#shipping").innerText = "TBD"
